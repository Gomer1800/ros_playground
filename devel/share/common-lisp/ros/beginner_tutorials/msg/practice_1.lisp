...
;//! \htmlinclude practice_1.msg.html

(cl:defclass <practice_1> (roslisp-msg-protocol:ros-message)
  ((first_name
    :reader first_name
    :initarg :first_name
    :type cl:string
...
(cl:defclass practice_1 (<practice_1>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <practice_1>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'practice_1)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name beginner_tutorials-msg:<practice_1> is deprecated: use beginner_tutorials-msg:practice_1 instead.")))

(cl:ensure-generic-function 'first_name-val :lambda-list '(m))
(cl:defmethod first_name-val ((m <practice_1>))
...
(cl:defmethod last_name-val ((m <practice_1>))
...
(cl:defmethod age-val ((m <practice_1>))
...
(cl:defmethod score-val ((m <practice_1>))
  ...
  (score m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <practice_1>) ostream)
  "Serializes a message object of type '<practice_1>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <practice_1>) istream)
  "Deserializes a message object of type '<practice_1>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<practice_1>)))
  "Returns string type for a message object of type '<practice_1>"
  "beginner_tutorials/practice_1")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'practice_1)))
  "Returns string type for a message object of type 'practice_1"
  "beginner_tutorials/practice_1")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<practice_1>)))
  "Returns md5sum for a message object of type '<practice_1>"
  "f8bfa80ae3c7a93455596d9622ad33a9")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'practice_1)))
  "Returns md5sum for a message object of type 'practice_1"
  "f8bfa80ae3c7a93455596d9622ad33a9")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<practice_1>)))
  "Returns full string definition for message of type '<practice_1>"
  (cl:format cl:nil "string first_name~%string last_name~%uint8 age~%uint32 score~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'practice_1)))
  "Returns full string definition for message of type 'practice_1"
  (cl:format cl:nil "string first_name~%string last_name~%uint8 age~%uint32 score~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <practice_1>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <practice_1>))
